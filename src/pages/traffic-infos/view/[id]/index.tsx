...
import { getTrafficInfoById } from 'apiSdk/traffic-infos';
import { TrafficInfoInterface } from 'interfaces/traffic-info';

function TrafficInfoViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Traffic Status" text={data?.traffic_status} />

                <FormListItem label="Alternative Route" text={data?.alternative_route} />

                <FormListItem
                  label="Expected Clear Time"
                  text={format(parseISO(data?.expected_clear_time as unknown as string), 'dd-MM-yyyy')}
                />

                <FormListItem label="Cause" text={data?.cause} />
