...
import { createAmenity } from 'apiSdk/amenities';
...
function AmenityCreatePage() {
  ...
  const handleSubmit = async (values: AmenityInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
  ...
  const formik = useFormik<AmenityInterface>({
    initialValues: {
      name: '',
      type: '',
